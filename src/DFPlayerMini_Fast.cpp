...
/*!
        ...
        @param    stream
                          A reference to the Serial instance (hardware or
   software) used to communicate with the MP3 player.
        @param    debug
                          Boolean used to specify if debug prints should be
   automatically printed to the serial monitor.
        @param    threshold
...
*/
/**************************************************************************/
bool DFPlayerMini_Fast::begin(Stream &stream, bool debug,
...
*/
/**************************************************************************/
void DFPlayerMini_Fast::sleep() { playbackSource(dfplayer::SLEEP); }
...
*/
/**************************************************************************/
void DFPlayerMini_Fast::wakeUp() { playbackSource(dfplayer::TF); }
...
*/
/**************************************************************************/
int16_t DFPlayerMini_Fast::currentVolume() { return query(dfplayer::GET_VOL); }
...
*/
/**************************************************************************/
int16_t DFPlayerMini_Fast::currentEQ() { return query(dfplayer::GET_EQ); }
...
*/
/**************************************************************************/
int16_t DFPlayerMini_Fast::currentMode() { return query(dfplayer::GET_MODE); }
...
*/
/**************************************************************************/
int16_t DFPlayerMini_Fast::numFolders() { return query(dfplayer::GET_FOLDERS); }
...
void DFPlayerMini_Fast::findChecksum(stack &_stack) {
  uint16_t checksum =
      (~(_stack.version + _stack.length + _stack.commandValue +
         _stack.feedbackValue + _stack.paramMSB + _stack.paramLSB)) +
      1;
...
void DFPlayerMini_Fast::printError() {
  if (recStack.commandValue == 0x40) {
    ...
    case 0x2: {
      Serial.println(F("Currently sleep mode(supports only specified device in "
                       "sleep mode)"));
      break;
    }
    case 0x3: {
